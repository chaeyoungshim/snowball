...
<!--                             <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5"> -->
                                    <div class="card-header mt-3" style="background: #BDE8F5;border-radius: 20px;opacity: 80%;"><h3 class="text-center font-weight-light my-2 justify-items-center">Co-Mapping</h3></div>
                                    <div class="card-body" style="flex:1 1 auto; pading:1rem 1rem;">
                                        <form>
                                            <div class="d-flex">
                                            	<sec:authorize access="!isAuthenticated()">
                                             	   <a class="btn btn-lg btn-block" style="width:100%; background-color: dodgerblue; color: white; border-color: dodgerblue;" href="/login">로그인하기</a>
                                            	</sec:authorize>
                                            	<sec:authorize access="isAuthenticated()">
